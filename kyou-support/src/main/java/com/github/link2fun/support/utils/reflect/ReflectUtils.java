package com.github.link2fun.support.utils.reflect;
...
public class ReflectUtils {
  ...
  public static <E> E invokeGetter(Object obj, String propertyName) {
    ...
    for (String name : StringUtils.split(propertyName, ".")) {
      String getterMethodName = GETTER_PREFIX + StrUtil.upperFirst(StringUtils.toCamelCase(name));
      ...
      for (int i = 0; i < cs.length; i++) {
        if (args[i] != null && !args[i].getClass().equals(cs[i])) {
          if (cs[i] == String.class) {
            ...
            if (StringUtils.endWith((String) args[i], ".0")) {
              args[i] = StringUtils.subBefore((String) args[i], ".0", false);
            }
  ...
  public static List<Field> getFieldsListWithAnnotation(final Class<?> cls, final Class<? extends Annotation> annotationCls) {
    ...
    final Field[] allFields = ReflectUtil.getFields(cls);
  ...
  public static void setFieldValueIfExists(Object entity, String fieldName, Object value) {
