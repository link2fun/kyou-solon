  ...
  return (
    <PageContainer>
      ...
      <div>
        ...
        <p>
          该项目是一个 Solon、EasyQuery 脚手架（接口和数据结构基本保持和 ruoyi
          一致）
        </p>
        <p>
          ruoyi 分支 完全兼容 RuoYi-Vue3 版本前端，任何兼容 ruoyi
          前后端分离的前端项目都可以使用当前后端作为服务。
        </p>
        ...
        <p>master</p>
        <p>
          为主开发版本, 以 ruoyi 为基础进行增强, 带来更好的使用体验, 不保证对
          ruiyi 的兼容性
        </p>
        <p>ruoyi</p>
        <p>
          分支为 Solon、EasyQuery 版本，接口和数据结构基本保持和 ruoyi 一致,
          基本可以保证 前端后端都兼容 ruoyi
        </p>
        ...
        <p>
          面向全场景的 Java 应用开发框架：克制、高效、开放、生态. 详见Solon 官网
        </p>
        <p>选择 Solon 的原因:</p>
        <ul>
        ...
        <ul>
          ...
          <li>支持强类型对象关系查询</li>
          <li>
            EasyQuery 的代码生成器插件, 可以图形化创建和修改查询实体 强烈安利,
            复杂业务实体可图形化勾选创建修改
          </li>
        </ul>
        ...
        <ul>
          <li>
            kyou-admin-ui-vue3-js: 前端Vue3项目(已移除, 请自行下载), 来自
            ruoyi-vue3-js
          </li>
          <li>
          ...
          <li>
            kyou-biz: 业务目录, 提供一些业务相关的功能,
            自己写的业务功能可以放到这里面
          </li>
          <li>
            kyou-gen-plugin: 代码生成器插件, 提供基于模板的代码生成能力,
            可生成通用 CRUD / 菜单 SQL 等
          </li>
          <li>kyou-main: 主目录, 提供应用启动类及配置</li>
          <li>
            kyou-schedule: 定时任务模块, 提供定时任务相关的功能,
            目前提供的是基于 solon simple-scheduler 的实现
          </li>
          <li>kyou-support: 支持包, 提供一些常用的工具类</li>
          <li>
            kyou-system: 系统包, 提供一些系统相关的功能, 如
            用户、角色、菜单、部门、岗位、字典、参数、日志、文件、缓存等
          </li>
          <li>
            kyou-tlog-solon-plugin: 提供基于 solon 的 tlog 日志插件,
            提供日志链路追踪等
          </li>
        </ul>
        <h2 className="text-2xl font-bold">建议用法</h2>
        <p>
          使用 PDManer 设计数据库, 管理SQL版本, 使用说明见:
          PDManer元数建模-v4-操作手册
        </p>
