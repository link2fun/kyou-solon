    ...
    >
      <table className={'w-full text-gray-600'}>
        ...
        <tr className={'border-b leading-8'}>
          <td>使用率</td>
          <td
            className={`${mem?.usage > 80 ? 'text-red-600' : mem?.usage > 60 ? 'text-orange-600' : 'text-green-600'}`}
          >
            {mem?.usage}%
          </td>
          <td
            className={`${jvm?.usage > 80 ? 'text-red-600' : jvm?.usage > 60 ? 'text-orange-600' : 'text-green-600'}`}
          >
            {jvm?.usage}%
          </td>
        </tr>
